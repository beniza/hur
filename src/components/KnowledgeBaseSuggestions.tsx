    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {matches.map((article) => (
                    <div key={article.id} className="group bg-white rounded-xl border border-slate-200 p-4 hover:shadow-md transition-all hover:border-indigo-200">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-slate-50 text-slate-700 text-sm font-medium hover:bg-indigo-50 hover:text-indigo-700 hover:border-indigo-200 border border-slate-200 transition-all"
                            >
                            ...
                            <a
                                ...
                                className="px-3 py-2 rounded-lg bg-slate-50 text-slate-500 hover:bg-slate-100 border border-slate-200 transition-all"
                            >
