        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="mb-6 pb-6 border-b border-slate-100">
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                        value={quickLogText}
                ...
                <div className="flex gap-2 mt-2">
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-xs font-medium text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-colors"
                    >
            ...
            <div className="space-y-3">
                ...
                >
                    ...
                    <span className="text-sm font-medium text-slate-700">Upload Call Recording</span>
                </Link>
                ...
                >
                    ...
                    <span className="text-sm font-medium text-slate-700">View My Tickets</span>
                </Link>
            </div>
        </div>
    );
